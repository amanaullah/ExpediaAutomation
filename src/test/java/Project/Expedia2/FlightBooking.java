...
public class FlightBooking {
	...
	public void f() throws InterruptedException {
		...
		Thread.sleep(6000);
		WebElement select1 = dr.findElement(By.xpath(
				"//*[contains(@data-test-id,'select-button-1') or @class='btn-secondary t-select-btn btn-sub-action']"));
		//WebDriverWait w1 = new WebDriverWait(dr, 10);

		select1.click();
		// dr.findElement(By.xpath("//*[contains(@data-test-id,'select-button-') or
		// @class='btn-secondary t-select-btn btn-sub-action']"));
		...
		/*
		 * USA is selected by default if you want to change the value uncomment the
		 * following two lines and change the value
		 */
		// Select se = new
		// Select(dr.findElement(By.xpath("//*[@aria-label='Country/TerritoryCode']")));
		// se.selectByValue("1");
		...
		// USA is selected by default if you want to change the country uncomment the
		// following two lines and provide the value
		// Select billingCountry = new
		// Select(dr.findElement(By.xpath("//*[@name='creditCards[0].country']")));
